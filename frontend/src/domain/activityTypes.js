export const ACTIVITY_TYPES = [
  ...
  { value: "alpine_ski", label: "Alpine ski", shortLabel: "Alpine", color: "#0F766E" },
  { value: "snowboarding", label: "Snowboarding", shortLabel: "Snow", color: "#7C3AED" },
  { value: "hiking", label: "Hiking", shortLabel: "Hike", color: "#16A34A" },
  { value: "alpinism", label: "Alpinism", shortLabel: "Alpine", color: "#9A5B36" },
  { value: "surfing", label: "Surfing", shortLabel: "Surf", color: "#0F766E" },
  { value: "hockey", label: "Hockey", shortLabel: "Hockey", color: "#9A5B36" },
  { value: "escalade", label: "Climbing", shortLabel: "Climb", color: "#7C3AED" },
  ...
  { value: "yoga", label: "Yoga", shortLabel: "Yoga", color: "#7C3AED" },
  { value: "pilates", label: "Pilates", shortLabel: "Pilates", color: "#2563EB" },
  { value: "other", label: "Other", shortLabel: "Other", color: "#667085" },
];
